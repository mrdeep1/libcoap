...
typedef struct oscore_ctx_t coap_oscore_ctx_t;
typedef struct oscore_sender_ctx_t coap_oscore_sender_ctx_t;
typedef struct oscore_recipient_ctx_t coap_oscore_recipient_ctx_t;
