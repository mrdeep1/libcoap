...
struct coap_oscore_conf_t {
  ...
  coap_crypto_pub_key_t *edhoc_pub_key;    /**< EDHOC R Public Key */
  coap_crypto_pri_key_t *edhoc_pri_key;    /**< EDHOC R Private Key */
  coap_bin_const_t *edhoc_dh_subject;      /**< EDHOC Static DH Subject */
  /* Support EDHOC Testing */
  coap_bin_const_t *test_ep_public_key; /**< Test EDHOC ephmeral DH Public
                                             Key */
  coap_bin_const_t *test_ep_private_key; /**< Test EDHOC ephmeral DH Private
                                              Key */
  coap_bin_const_t *test_st_public_key;  /**< Test EDHOC static DH Public
                                              Key */
  coap_bin_const_t *test_st_private_key; /**< Test EDHOC static DH Private
                                              Key */
