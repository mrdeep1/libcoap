...
int16_t message_2_receipt(unsigned char *data, size_t len, uint16_t code, uint16_t block_num,
                          uint16_t more);

/* stores message4 received for edhoc after message_1 */
int16_t edhoc_message_4_receipt(unsigned char *data, size_t len, uint16_t code, uint16_t block_num,
                                uint16_t more);
#endif
