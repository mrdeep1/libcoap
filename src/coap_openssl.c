...
#if COAP_WS_SUPPORT || COAP_OSCORE_GROUP_SUPPORT || COAP_OSCORE_EDHOC_SUPPORT
static void
...
#endif /* COAP_WS_SUPPORT || COAP_OSCORE_GROUP_SUPPORT || COAP_OSCORE_EDHOC_SUPPORT */
...
#if defined(COAP_OSCORE_EDHOC_SUPPORT)
#if OPENSSL_VERSION_NUMBER >= 0x10101000L
  return 1;
#else  /* OPENSSL_VERSION_NUMBER < 0x10101000L */
  return 0;
#endif /* OPENSSL_VERSION_NUMBER < 0x10101000L */
#else  /* !COAP_OSCORE_EDHOC_SUPPORT */
  return 0;
...
static int
fix_public_key_info(EVP_PKEY *pub_key, coap_bin_const_t *cert_der, coap_crypto_pub_key_t *local) {
  int length;
  size_t size;
  unsigned char *p;
  coap_binary_t *dummy = NULL;
